...
class EqualSpeciality implements Equalable<Person> {
    @Override
    public boolean equals(Person t1, Person t2) {
        Student s1, s2;
        if (t1.equals(t2)) {
        ...
        if (t1 instanceof Student && t2 instanceof Student) {
            s1 = (Student) t1;
            s2 = (Student) t2;
            return s1.speciality.equals(s2.speciality);
        }
        return false;
    }
...
class EqualAcademy implements Equalable<Person> {
    @Override
    public boolean equals(Person t1, Person t2) {
        Student s1, s2;
        if (t1.equals(t2)) {
        ...
        if (t1 instanceof Student && t2 instanceof Student) {
            s1 = (Student) t1;
            s2 = (Student) t2;
            return s1.academy.equals(s2.academy);
        }
        return false;
    }
}

class EqualPolity implements Equalable<Person>{
    @Override
    public boolean equals(Person t1, Person t2) {
        Student s1, s2;
        if (t1.equals(t2)) {
        ...
        if (t1 instanceof Student && t2 instanceof Student) {
            s1 = (Student) t1;
            s2 = (Student) t2;
            return s1.policy.equals(s2.policy);
        }
        return false;
    }
}
