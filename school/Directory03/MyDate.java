...
//        System.out.println(count);
    ...
    public String toString() {
        return year + "year" + String.format("%2d", month) + "month" + String.format("%2d", date) + "day";
    }
...
//        System.out.println("this year is " + MyDate.getThisYear() + "leap year?" + MyDate.isLeapYear(MyDate.getThisYear()));
//
//        MyDate md = new MyDate();
//        md.set(2020, 4, 26);
//        System.out.println("this year is " + md.getYear() + "leap year?" + md.isLeapYear());
//
//        MyDate md1 = new MyDate(md);
//        System.out.println("md :" + md + "  md1" + md1);
//        System.out.println("equals:" + md.equals(md1));
...
//        MyDate myDate = new MyDate(2020, 5, 9);
//        System.out.println(myDate + "是星期" + myDate.getWeek());

        MyDate myDate1 = new MyDate(2020, 4, 28);
        myDate1 = myDate1.dayAfter(344);
